...
手机宽度下优先展示重点信号和主图，指标设置默认折叠，快单面板随页面排列，不会遮挡主图。斐波那契支持锚点方向与扩展控制；套轨卡片可收起四周期明细，为主图腾出更多高度。详见[发布说明](docs/releases/release-notes.md)。
...
- 时间信号线：主图底部色点汇总近期触发事件；悬停时以竖线连接对应 K 线，「信号线」按钮可开关
- 右上角多周期提示：1 分、15 分、1 小时、1 日的多空状态
...
| 高低 / 反弹 / 回踩 / 诱空诱多 / 企稳 / 套轨 / 高空低多 / 箱体震荡 / 斐波那契 / 超级趋势 / EMA9 / EMA21 / MA100 / EMA100 | 在指标下拉里单独开关；套轨开启后可分别开关 1 分、5 分、15 分、1 小时轨道及信号标记；MA100 为 100 根收盘价简单移动平均，EMA100 为 100 根指数移动平均；斐波那契可选自动、低点到高点、高点到低点，并可开关 1.272 / 1.618 扩展 |
